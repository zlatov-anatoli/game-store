  ...
  useEffect(() => {
    const getGameId = async () => {
      const res = await axios.get(
        'https://6419524029e7e36438fa9a49.mockapi.io/games/' + gameId
      )
      setData(res.data)
    }
    getGameId()
    ...
    <>
      <div className={classes.block}>
        ...
        <div className={classes.wrapper}>
          <img className={classes.image} src={data.image} alt="Games" />
          <h1 className={classes.title}>{data.title}</h1>
          <div className={classes.inner}>
            <span className={classes.price}>{data.price} руб.</span>
